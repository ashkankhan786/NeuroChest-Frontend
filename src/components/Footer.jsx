...
function Footer() {
  return (
    <footer className="w-full bg-black/80 border-t border-green-800 mt-20 py-6 px-6 flex flex-col sm:flex-row items-center justify-between text-sm text-gray-400">
      <a
      ...
      <p className="mt-4 sm:mt-0 mr-2">
        &copy; 2025 NeuroChest. All rights reserved.
      </p>
    </footer>
  );
}
